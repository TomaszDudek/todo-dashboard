...
{#if formularSichtbar}
  <div class="modal {formularSichtbar}" transition:fade>
      ...
      <div class="box">
        <form on:submit|preventDefault={speichereFormular}>
          <div class="field mb-4">
            ...
            <div class="control">
              <textarea class="textarea" placeholder="Inhalt" bind:value={inhalt} />
            </div>
          </div>
          <div class="field is-grouped">
            ...
            <div class="control">
              <button type="submit" class="button is-danger" on:click={formularSchliessen}
                >Abbrechen</button
              >
            </div>
          </div>
    ...
    <button on:click={formularSchliessen} class="modal-close is-large" aria-label="close" />
  </div>
{/if}
